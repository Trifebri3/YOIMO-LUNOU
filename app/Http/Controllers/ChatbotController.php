    ...
    public function query(Request $request): JsonResponse
    {
        ...
        // 7. Dynamic LLM Chat fallback (using AIService)
            ...
            try {
                ...
                if (json_last_error() === JSON_ERROR_NONE && is_array($data)) {
                    ...
                    foreach ($actions as $action) {
                        ...
                        if (($action['type'] ?? '') === 'create_task') {
                            ...
                            \App\Models\ProjectActivityLog::record($action['project_id'], 'Task', 'CREATE', "Membuat tugas baru via Chatbot: '{$newTask->title}'");
                            ...
                            \App\Models\ProjectActivityLog::record($action['project_id'], 'Agenda', 'CREATE', "Menjadwalkan agenda baru via Chatbot: '{$newAgenda->title}'");
                        }
                    }
                } else {
                ...
                \Illuminate\Support\Facades\Log::error('Chatbot AI Exception: ' . $e->getMessage() . "\n" . $e->getTraceAsString());
