...
public function create(Request $request): View
    {
        ...
        // Ambil hanya user dengan role 'user' dan 'finance'
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($request->hasFile('doc_files')) {
            foreach ($request->file('doc_files') as$idx => $file) {$path = $file->store('project_docs', 'public');$documents[$idx]['file_url'] =$path;
            }
        }
