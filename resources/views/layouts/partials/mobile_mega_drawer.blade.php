...
<aside id="mobile-sidebar" 
       class="fixed inset-y-0 left-0 z-50 w-80 sm:w-96 bg-white border-r border-slate-200/80 flex flex-col justify-between h-[100dvh] max-h-[100dvh] xl:h-screen shrink-0 font-sans hidden xl:flex xl:sticky xl:top-0 shadow-2xl xl:shadow-none overflow-hidden transition-all duration-300">
    ...
    <div class="flex-1 overflow-y-auto min-h-0 overscroll-contain p-4 sm:p-5 space-y-5 divide-y divide-slate-100" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: contain;">
                ...
                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100/70 rounded-2xl p-3">
                    <div class="flex items-center justify-between text-xs font-bold text-emerald-950 mb-1">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3 h-3 text-emerald-600 fill-current shrink-0" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
